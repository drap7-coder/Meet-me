      ...
      {WATCH_SUBCATEGORIES.map((option) => (
        ...
        >
          <div className="flex min-w-0 items-center gap-4">
            <span className="category-icon-wrapper grid h-14 w-14 shrink-0 place-items-center rounded-full bg-[#F7F1E8] text-slate transition group-hover:bg-[#EDFFED] group-hover:text-clay sm:h-16 sm:w-16">
