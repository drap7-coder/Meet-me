      ...
      <div className="flex w-full min-w-0 items-center justify-between gap-4 sm:gap-6">
        <div className="min-w-0 flex-1">
          <h1 className="font-semibold tracking-[-0.04em]">
            <span className="block text-[clamp(1.4rem,6.3vw,2.275rem)] leading-[0.95] text-white">{BRAND.heroHeadlineLead}</span>
            <span className="mt-1 block text-[clamp(1.4rem,6.3vw,2.275rem)] leading-[0.95]">
        ...
        <Logo size="hero" onDark className="origin-right shrink-0 scale-[0.7] opacity-[0.88]" />
      </div>
    </div>
  );
}
